...
In addition, our group thinks there is no reason that the price per milligram can be a non-positive value or values greater than 10 (may because some people input the total price by mistake). The number of the ovservations we have is 5,582 now.
